...
A `SingleCellExperiment` object containing gene expression from testis single
cell RNAseq experiment (`The adult human testis transcriptional cell atlas`
(Guo et al. 2018)):
...
A `SummarizedExperiment` object containing gene expression in different human 
